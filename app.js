...
const storyThemesDB = {
    ...
    '哈尔滨中央大街': [
        {
            mainTitle: '面包石路·光影密码',
            subTitle: '百年方石路承载的移民史诗',
            elements: ['面包石路', '俄式工艺', '光影艺术', '移民文化', '历史印记'],
            description: '以中央大街独特的面包石路为核心，打造光影交织的历史主题酒店。大堂地面采用方石纹理设计，客房融入光影艺术元素，公共区域展现俄式工艺美学，让客人踏着历史的足迹感受百年商埠的韵味。'
        },
        {
            mainTitle: '马迭尔阳台·琴音秘语',
            subTitle: '俄侨音乐传统的现代演绎',
            elements: ['阳台音乐', '俄侨文化', '古典音乐', '建筑美学', '艺术传承'],
            description: '以马迭尔宾馆的阳台音乐传统为灵感，将音乐文化融入酒店设计。客房阳台设计成音乐角落，公共空间定期举办室内音乐会，让客人在优雅的旋律中感受哈尔滨"音乐之城"的魅力。'
        },
        {
            mainTitle: '冰雪窗花·寒地美学',
            subTitle: '东北冰雪文化的艺术表达',
            elements: ['冰雪窗花', '寒地文化', '剪纸艺术', '冬季美学', '民俗传承'],
            description: '以道里区特有的冰雪窗花艺术为核心，打造寒地美学主题酒店。客房窗户设计成艺术装置，公共区域展示冰雪剪纸作品，让客人在温暖的室内感受冰城独特的"以美御寒"生活哲学。'
        },
        {
            mainTitle: '万国建筑·欧陆风情',
            subTitle: '多元建筑文化的空间融合',
            elements: ['万国建筑', '欧式风格', '建筑艺术', '文化融合', '历史建筑'],
            description: '以中央大街71栋保护建筑为设计灵感，将多国建筑风格融入酒店空间。不同楼层采用不同欧式风格，客房融入巴洛克、文艺复兴等元素，让客人在一座酒店中游览"建筑艺术博物馆"。'
        },
        {
            mainTitle: '犹太商贾·商埠传奇',
            subTitle: '国际商贸文化的现代诠释',
            elements: ['犹太文化', '商贸历史', '国际化', '商业传奇', '文化交融'],
            description: '以犹太商人在哈尔滨的创业传奇为主题，打造国际商务文化酒店。大堂设计成商贸展示空间，客房融入犹太文化元素，公共区域展现国际商埠的繁荣景象，让客人感受"东方莫斯科"的商业魅力。'
        },
        {
            mainTitle: '松花江畔·冰城印象',
            subTitle: '松花江文化的诗意表达',
            elements: ['松花江', '江畔文化', '冰城特色', '自然景观', '城市印象'],
            description: '以松花江的自然美景和文化内涵为核心，打造江畔风情主题酒店。客房设计成江景观景台，公共空间融入江水元素，让客人在城市中心感受松花江的诗意与浪漫，体验真正的"冰城印象"。'
        },
    ],
    '杭州': [
        {
